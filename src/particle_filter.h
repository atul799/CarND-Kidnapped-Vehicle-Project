...
struct Particle {
	...
	//to get a sense of cloud size for particle
	int nr_times_resampled;
};

//find particle survived and it's size (nr of times resampled)
//std::vector<int> particle_cloud_list (100,0);
